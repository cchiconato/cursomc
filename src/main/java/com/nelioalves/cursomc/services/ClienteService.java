...
import com.nelioalves.cursomc.dto.ClienteInsertDTO;
...
public class ClienteService {
	...
	public Cliente update(Cliente obj) {
		Cliente newObj = repo.getOne(obj.getId());
	...
	public Cliente findByEmail(String email) {
		...
		return obj.orElseThrow(() -> new ObjectNotFoundException("Objeto não encontrado! id: " + user.getId()
